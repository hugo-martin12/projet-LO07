  ...
  <div class="container">
    ...
    <form role="form" method='get' action='router2.php'>
      <div class="form-group">
        ...
        <input type="hidden" name='action' value='conexionInscription'>
        <label style='width:8%' for="id">Nom :    </label> <input type="text" name='nom' size='15' style='margin:2px'> <br/>
        <label style='width:8%' for="id">Prenom :    </label> <input type="text" name='prenom' size='15' style='margin:2px'> <br/>
        <label style='width:8%' for="id">Adresse :    </label> <input type="text" name='adresse' size='15' style='margin:2px'> <br/>     
